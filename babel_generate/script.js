...
class Selector extends React.Component {
  ...
  render() {
    ...
    }, this.props.number / 60), /*#__PURE__*/React.createElement("div", {
      className: "control selector_item",
...
class Presentational extends React.Component {
  ...
  updateCount() {
    ...
    if (this.state.time_value[this.state.mode] > 0) {
      this.setState(state => {
        //copy the state
        let new_state = Object.assign({}, state); //reduce the active timer by 1sec
      ...
      document.getElementById("beep").play(); //update the state
  ...
  stopCountDown(event) {
    //if the timer is running clear the setInterval
    clearInterval(this.state.interval_id); //by spec stop and rewind the rewind the audio

    let audio = document.getElementById("beep");
    audio.pause();
    audio.currentTime = 0; //set the modes timer values back to original values
  ...
  render() {
    return /*#__PURE__*/React.createElement("div", {
      ...
      name: "Break Length",
      id_prefex: "break",
      number: this.state.break_length,
      clickBackUp: this.handleIncrement,
      clickBackDown: this.handleDecrement
    }), /*#__PURE__*/React.createElement(Selector, {
      name: "Session Length",
      id_prefex: "session",
      number: this.state.session_length,
      clickBackUp: this.handleIncrement,
      clickBackDown: this.handleDecrement
    })), /*#__PURE__*/React.createElement("div", {
      id: "timer"
      ...
      id: "timer-label",
      className: "none_select"
    }, this.state.current_label[this.state.mode]), /*#__PURE__*/React.createElement("div", {
      id: "time-left",
      className: "none_select"
    }, this.convertTimer()), /*#__PURE__*/React.createElement("div", {
      id: "timer_controls"
    }, /*#__PURE__*/React.createElement("div", {
      id: "start_stop",
      ...
      className: this.state.run ? "fa fa-pause" : "fa fa-play",
      "aria-hidden": "true"
    })), /*#__PURE__*/React.createElement("div", {
      id: "reset",
